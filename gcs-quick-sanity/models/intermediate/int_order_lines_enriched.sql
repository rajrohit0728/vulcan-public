MODEL (
  name gcslhdepot.intermediate_v6_vnew.int_order_lines_enriched,
  kind FULL,
...
FROM (
  ...
  FROM gcslhdepot.staging_v6_vnew.stg_order_items AS oi
  JOIN gcslhdepot.staging_v6_vnew.stg_orders AS o
    ON oi.order_id = o.order_id
  JOIN gcslhdepot.staging_v6_vnew.stg_customers AS c
    ON o.customer_id = c.customer_id
  JOIN gcslhdepot.staging_v6_vnew.stg_products AS p
