MODEL (
  name abfsslhdepotrr.intermediate_v5_vnew.int_order_lines_enriched,
  kind FULL,
...
FROM (
  ...
  FROM abfsslhdepotrr.staging_v5_vnew.stg_order_items AS oi
  JOIN abfsslhdepotrr.staging_v5_vnew.stg_orders AS o
    ON oi.order_id = o.order_id
  JOIN abfsslhdepotrr.staging_v5_vnew.stg_customers AS c
    ON o.customer_id = c.customer_id
  JOIN abfsslhdepotrr.staging_v5_vnew.stg_products AS p
