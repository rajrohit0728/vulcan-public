...
**Staging** (`abfsslhdepotrr.staging_v4_vnew`, `kind SEED`) — one seed model per CSV,
...
**Intermediate** (`abfsslhdepotrr.intermediate_v4_vnew`, `kind FULL`):
...
**Mart** (`abfsslhdepotrr.mart_v4_vnew`, `kind FULL`) — consumption-ready:
