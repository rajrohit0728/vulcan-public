MODEL (
  name bigqueryrr.mart_v4_vnew.customer_region_rank,
  kind FULL,
...
FROM (
  ...
  FROM bigqueryrr.mart_v4_vnew.dim_customers AS c
  LEFT JOIN bigqueryrr.mart_v4_vnew.fct_order_lines AS f
